...
DEVICE_CONFIGS: dict[str, DeviceConfig] = {
    ...
    "cc25019224_chlorinator": DeviceConfig(
        ...
        # Full mapping confirmed by @alapedra's v2.35.1 diagnostics: this unit
        # ships with pH and ORP probes (not the base model as initially assumed).
        ...
        features={
            ...
            "orp_setpoint": 20,  # Component 20 (mV) — e.g., 720 mV
            "skip_mode_select": True,  # No mode select on this model
            "sensors": {
                "ph": 165,  # pH measured (÷100) — e.g., 721 = 7.21 pH
                "orp": 170,  # ORP/Redox measured (mV) — e.g., 654 mV
                "temperature": 172,  # Pool temperature (°C × 10) — e.g., 260 = 26.0°C
                "salinity": 174,  # Salinity (g/L × 100) — e.g., 627 = 6.27 g/L
            },
            "specific_components": [10, 16, 20, 165, 170, 172, 174],
        },
        priority=87,
    ...
    "lc24026011_chlorinator": DeviceConfig(
        ...
        # Same mapping as LC25000122 (confirmed by @flyman1664 on Issue #53)
        ...
        features={
            ...
            "orp_setpoint": 20,  # Component 20 (mV) — e.g., 710 mV
            "skip_mode_select": True,  # No mode select on this model
            "sensors": {
                "ph": 165,  # pH measured (÷100)
                "orp": 170,  # ORP/Redox measured (mV)
                "temperature": 172,  # Pool temperature (°C × 10) — e.g., 204 = 20.4°C
                "salinity": 174,  # Salinity (g/L × 100)
            },
            "specific_components": [10, 16, 20, 165, 170, 172, 174],
        },
    ...
    "lc25000122_chlorinator": DeviceConfig(
        ...
        features={
            ...
            "skip_mode_select": True,  # No mode select on this model
            "sensors": {
                "ph": 165,  # pH measured (÷100) — e.g., 731 = 7.31 pH
                "orp": 170,  # ORP/Redox measured (mV) — e.g., 727 mV
                "temperature": 172,  # Pool temperature (°C × 10) — e.g., 188 = 18.8°C
                "salinity": 174,  # Salinity (g/L × 100) — e.g., 589 = 5.89 g/L
            },
            # Specific components for LC25000122 (same as LC24013306/LC24015802 family)
            "specific_components": [10, 16, 20, 165, 170, 172, 174],
        },
        priority=87,  # Higher than generic *.nn_* (80) and the LC2 family (86)
    ),
