...
CHLORINATOR_CONFIGS: dict[str, DeviceConfig] = {
    ...
    "lc24013306_chlorinator": _standard_tecnolc2(
        ...
        # (c164 was tried as a live-output register but reads 0 even while the cell
        # produces — Issue #156 — so it is not mapped; salinity going non-zero is
        # the real "cell active" signal on this family.)
